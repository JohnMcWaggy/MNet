...
public interface ITcpFrame : IResettable {
    ...
    /// <summary>
    ///     While reading a incomming frame, the moment you set the <see cref="Identifier" /> something other than
    ///     <see langword="null" />, the frame will be
